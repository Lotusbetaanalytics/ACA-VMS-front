    ...
    <div className="viewprebook__container">
      ...
      <div className="data__container">
        ...
        {loading ? (
          ...
          <ShowDataTable data={data} title="Pending Guests" />
        )}
      </div>
    </div>
  );
...
export default StaffPendingGuests;
